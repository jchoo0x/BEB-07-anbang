...
<footer className=" bg-gray-200 sm:p-6 mt-auto w-screen h-15">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/codestates-beb/BEB-07-anbang" className="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">©안방<a href="#" className="hover:underline"></a>. All Rights Reserved.
        </span>
